...
- [完整命令参考](#完整命令参考)
  ...
  - [auth — 认证管理](#auth--认证管理)
  - [draft — 草稿箱管理](#draft--草稿箱管理)
  - [media — 素材管理](#media--素材管理)
  - [stats — 数据统计](#stats--数据统计)
  - [md2html — Markdown 转公众号 HTML](#md2html--markdown-转公众号-html)
  - [write — AI 风格化写作](#write--ai-风格化写作)
...
```bash
# 用户增减数据（最大跨度 7 天）
wechat-cli stats user --begin-date 2025-01-01 --end-date 2025-01-07
wechat-cli stats user --begin-date 2025-01-01 --end-date 2025-01-07 --type cumulate

# 图文分析数据
wechat-cli stats article --begin-date 2025-01-01 --end-date 2025-01-01
wechat-cli stats article --begin-date 2025-01-01 --end-date 2025-01-01 --type total

# 消息分析数据
wechat-cli stats message --begin-date 2025-01-01 --end-date 2025-01-07
```
...
<details>
<summary><b>常用 API 路径参考</b></summary>
...
| Skill | 文件 | 用途 |
|-------|------|------|
| 概览 | `skills/README.md` | Skill 体系总览与加载说明 |
